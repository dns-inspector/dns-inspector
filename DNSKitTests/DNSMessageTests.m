...
- (void) testParseDNSSOAMessage {
    ...
    DNSSOARecordData * data = (DNSSOARecordData *)message.answers[0].data;
    XCTAssertNotNil(data);
    XCTAssertStringEqual(data.mname, @"ns.icann.org.");
    XCTAssertStringEqual(data.rname, @"noc.dns.icann.org.");
...
- (void) testParseDNSDSMessage {
    ...
    XCTAssertEqual(message.answers[0].recordType, DNSRecordTypeDS);
    DNSDSRecordData * data = (DNSDSRecordData *)message.answers[0].data;
    XCTAssertNotNil(data);
    XCTAssertEqual(data.algorithmType, DNSSECAlgorithmRSA_SHA256);
    XCTAssertEqual(data.digestType, DNSSECDigestSHA256);
    XCTAssertStringEqual(message.answers[0].stringValue, @"dns.google. 900 IN DS 56044 8 2 1b0a7e90aa6b1ac65aa5b573efc44abf6cb2559444251b997103d2e40c351b08");
}
...
- (void) testParseDNSSECMessage {
    ...
    XCTAssertEqual(data3.algorithm, DNSSECAlgorithmRSA_SHA256);
